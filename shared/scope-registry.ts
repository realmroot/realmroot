export const realmrootScopeRegistry = {
  ...
  'users:write': { resource: 'user', action: 'write', organization: false },
  ...
  'connectors:write': { resource: 'connector', action: 'write', organization: false },
  'settings:read': { resource: 'realm', action: 'read', organization: false },
  'settings:write': { resource: 'realm', action: 'write', organization: false },
  'security:read': { resource: 'security', action: 'read', organization: false },
  'security:write': { resource: 'security', action: 'write', organization: false },
  'readiness:read': { resource: 'readiness', action: 'read', organization: false },
