...
export const platformWebhookRoutes: ManagementRouteConfig[] = [
  ...
  },
  {
    ...
    summary: 'Get Realm general settings',
    response: managementGeneralSettingsResponseSchema,
  },
  {
    method: 'patch',
    path: '/general-settings',
    operationId: 'updateGeneralSettings',
    summary: 'Update Realm general settings',
    request: { body: jsonBody(updateManagementGeneralSettingsRequestSchema) },
    response: managementGeneralSettingsResponseSchema,
  },
  {
    method: 'get',
    ...
    response: managementEmailSettingsResponseSchema,
  },
  {
    method: 'patch',
    path: '/email-settings',
    ...
    request: { body: jsonBody(updateManagementEmailSettingsRequestSchema) },
    response: managementEmailSettingsResponseSchema,
  },
  {
    method: 'patch',
  ...
  },
  {
    ...
    summary: 'Get developer access settings',
    response: managementDeveloperSettingsResponseSchema,
  },
  {
    method: 'patch',
    path: '/developer-settings',
    operationId: 'updateDeveloperSettings',
    summary: 'Update developer access settings',
    request: { body: jsonBody(updateManagementDeveloperSettingsRequestSchema) },
    response: managementDeveloperSettingsResponseSchema,
  },
  {
    method: 'post',
