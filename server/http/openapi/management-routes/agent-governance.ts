...
export const agentGovernanceRoutes: ManagementRouteConfig[] = [
  ...
  {
    method: 'get',
    path: '/agents/{agentId}/permission-contexts',
    operationId: 'listAgentPermissionContexts',
    summary: 'List Contexts a controller can select when granting Agent permissions',
    security: [{ oauth2: ['permissions:read'] }, { sessionCookie: ['permissions:read'] }],
    request: { params: z.object({ agentId: z.string() }), query: agentPermissionContextsQuerySchema },
    response: agentPermissionContextsResponseSchema,
    paginated: true,
    errors: {
      400: 'The external account must be connected.',
      403: 'Agent controller authority is required.',
  ...
  },
  {
    ...
    summary: 'Grant an Agent permission without an access request',
