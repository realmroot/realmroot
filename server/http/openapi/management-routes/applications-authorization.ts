...
export const applicationAuthorizationRoutes: ManagementRouteConfig[] = [
  ...
  {
    method: 'get',
    path: '/users/{userId}/authorized-resource-servers',
    operationId: 'listUserAuthorizedResourceServers',
    summary: 'List Resource Servers authorized for a User',
  ...
  },
  {
    ...
    summary: 'Create a direct User Permission',
    security: [{ oauth2: ['permissions:write'] }, { sessionCookie: ['permissions:write'] }],
    request: { params: z.object({ userId: z.string() }), body: jsonBody(createUserPermissionRequestSchema) },
  ...
  },
  {
    ...
    summary: 'Get a direct User Permission',
    security: [{ oauth2: ['permissions:read'] }, { sessionCookie: ['permissions:read'] }],
    request: { params: z.object({ userId: z.string(), permissionId: z.string() }) },
    response: permissionResponseSchema,
    errors: { 404: 'The User Permission was not found.' },
  },
  {
    method: 'delete',
    path: '/users/{userId}/permissions/{permissionId}',
    operationId: 'deleteUserPermission',
    summary: 'Revoke a direct User Permission',
    security: [{ oauth2: ['permissions:write'] }, { sessionCookie: ['permissions:write'] }],
    request: { params: z.object({ userId: z.string(), permissionId: z.string() }) },
    noBody: true,
    errors: { 404: 'The User Permission was not found.' },
  ...
  {
    method: 'get',
    path: '/applications/{applicationId}/authorized-resource-servers',
    operationId: 'listApplicationAuthorizedResourceServers',
    summary: 'List Resource Servers authorized for an Application',
    security: [{ oauth2: ['permissions:read'] }, { sessionCookie: ['permissions:read'] }],
    request: {
  ...
  },
  {
    ...
    summary: 'List an Application’s direct Permissions',
    security: [{ oauth2: ['permissions:read'] }, { sessionCookie: ['permissions:read'] }],
  ...
  },
  {
    ...
    summary: 'Create a direct Application Permission',
    security: [{ oauth2: ['permissions:write'] }, { sessionCookie: ['permissions:write'] }],
    request: {
      params: z.object({ applicationId: z.string() }),
      body: jsonBody(createApplicationPermissionRequestSchema),
    },
    response: permissionResponseSchema,
    status: 201,
    responseHeaders: locationResponseHeader,
  ...
  },
  {
    ...
    operationId: 'getApplicationPermission',
    summary: 'Get a direct Application Permission',
    security: [{ oauth2: ['permissions:read'] }, { sessionCookie: ['permissions:read'] }],
    request: { params: z.object({ applicationId: z.string(), permissionId: z.string() }) },
    response: permissionResponseSchema,
    errors: { 404: 'The Application Permission was not found.' },
  },
  {
    method: 'delete',
    path: '/applications/{applicationId}/permissions/{permissionId}',
    operationId: 'deleteApplicationPermission',
    summary: 'Revoke a direct Application Permission',
    security: [{ oauth2: ['permissions:write'] }, { sessionCookie: ['permissions:write'] }],
    request: { params: z.object({ applicationId: z.string(), permissionId: z.string() }) },
    noBody: true,
    errors: { 404: 'The Application Permission was not found.' },
