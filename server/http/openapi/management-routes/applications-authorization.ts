...
export const applicationAuthorizationRoutes: ManagementRouteConfig[] = [
  ...
  {
    method: 'get',
    path: '/api-resources/{id}/external-authorization',
    operationId: 'getExternalApiResourceAuthorization',
    summary: 'Get external API resource authorization',
    request: { params: idParam },
    response: externalResourceAuthorizationSchema,
  },
  {
    method: 'put',
    path: '/api-resources/{id}/external-authorization',
    operationId: 'configureExternalApiResourceAuthorization',
    summary: 'Configure external API resource authorization',
    request: {
      params: idParam,
      body: jsonBody(configureExternalResourceAuthorizationRequestSchema),
    },
    response: externalResourceAuthorizationSchema,
  },
  {
