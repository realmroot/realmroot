...
export const applicationAuthorizationRoutes: ManagementRouteConfig[] = [
  ...
  {
    method: 'get',
    path: '/applications/{applicationId}/authorizations/{authorizationId}',
    operationId: 'getApplicationAuthorization',
    summary: 'Get an Application authorization',
    request: { params: applicationAuthorizationParam },
  ...
  },
  {
    method: 'delete',
    path: '/applications/{applicationId}/authorizations/{authorizationId}',
    operationId: 'deleteApplicationAuthorization',
    summary: 'Delete an active Application authorization',
    request: { params: applicationAuthorizationParam },
    noBody: true,
    errors: { 404: 'The Application authorization was not found.' },
  },
  {
    method: 'get',
    path: '/users/{userId}/application-authorizations',
    operationId: 'listUserApplicationAuthorizations',
