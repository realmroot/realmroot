import type { AgentBindings } from '@server/modules/agents/context'
import type { ApplicationBindings } from '@server/modules/applications/context'
import { type AuthorizationBindings, createAuthorizationService } from '@server/modules/authorization/context'
