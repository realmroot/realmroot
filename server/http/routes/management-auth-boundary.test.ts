...
const operationsWithExplicitSecurity = new Set([
  ...
  'GET /agents/{param}/scope-entitlements',
  'GET /agents/{param}/scope-entitlements/{param}',
  'DELETE /agents/{param}/scope-entitlements/{param}',
  'GET /users/{param}/scope-entitlements',
  'POST /users/{param}/scope-entitlements',
  'GET /users/{param}/scope-entitlements/{param}',
  'DELETE /users/{param}/scope-entitlements/{param}',
  'GET /applications/{param}/scope-entitlements',
  'POST /applications/{param}/scope-entitlements',
  'GET /applications/{param}/scope-entitlements/{param}',
  'DELETE /applications/{param}/scope-entitlements/{param}',
])
