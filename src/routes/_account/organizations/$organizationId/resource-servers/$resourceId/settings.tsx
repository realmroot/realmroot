...
export const Route = createFileRoute('/_account/organizations/$organizationId/resource-servers/$resourceId/settings')({
...
function OrganizationResourceServerSettingsRoute() {
  ...
  return (
    <AccountOrganizationDetailPage
      content={<ApiResourceDetailPage organizationId={organizationId} resourceId={resourceId} section="settings" />}
