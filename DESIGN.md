...
layout:
  ...
  console:
    ...
    detailPages:
      ...
      - Keep OAuth consent with Applications, human authority with Organization membership Roles, and delegated authority with each Agent's Permissions.
      ...
      - Keep Permissions below their User, Application, or Agent owner; do not add an aggregate cross-subject grants tab. Scope grant modes remain maintained in Scopes.
